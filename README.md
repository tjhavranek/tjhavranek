...
| Triage an ERC Starting/Consolidator draft before peer review | [**erc-ai-feedback**](https://github.com/tjhavranek/erc-ai-feedback) | A prompt and rubric for a structured pre-review against ERC criteria. It clears routine problems before workshop time is spent on them, and it does not replace human reviewers. |
| Check a GA UK application before submitting it | [**gauk-ai-feedback**](https://github.com/tjhavranek/gauk-ai-feedback) · [app](https://tjhavranek.github.io/gauk-ai-feedback/) | An unofficial pre-submission review for the Charles University Grant Agency, in Czech and English: formal problems first, then whether the application says what the project will add. It checks the attachments inside the browser without uploading them, and it never writes the application. I sit on the GA UK Grant Council, and the [disclosure](https://github.com/tjhavranek/gauk-ai-feedback/blob/main/DISCLOSURE.md) says what follows from that. |
| Get feedback on an economics thesis before the seminar | [**ies-thesis-feedback**](https://github.com/tjhavranek/ies-thesis-feedback) · [app](https://tjhavranek.github.io/ies-thesis-feedback/) | For bachelor's and master's students at the Institute of Economic Studies: send a chatbot anything from an idea to a finished thesis and get it read the way your supervisor and opponent will, before the seminar. |
...
The workshop (CRUCIBLE), the more advanced tool: Havránek & Iršová (2026), [doi:10.5281/zenodo.20828996](https://doi.org/10.5281/zenodo.20828996). The audit protocol it grew out of: Iršová & Havránek (2026), [doi:10.5281/zenodo.19105954](https://doi.org/10.5281/zenodo.19105954). The experiment: Havránek & Iršová (2026), [arXiv:2607.14713](https://arxiv.org/abs/2607.14713). The datasets: [doi:10.5281/zenodo.21773678](https://doi.org/10.5281/zenodo.21773678), together with the individual paper whose data you use. Most tool repos ship a `CITATION.cff`, so GitHub's "Cite this repository" works there too.
...
*Getting started:* gauk-ai-feedback and ies-thesis-feedback are web pages that hand a prompt to any chatbot, and research-audit-duel-protocol and erc-ai-feedback are just prompts and documents, so none of them needs anything installed (their optional agent routes do). CRUCIBLE and mad-research are Claude Code skills, so they need a Claude subscription (mad-research also calls Codex). Claude Code runs in the Claude desktop app as well as in a terminal. Each repo's README has the steps.

*A note on confidentiality:* an AI review sends your text to the provider of the chatbot or agent you use. The local checks, such as the GA UK app's file check, send nothing. Each repo's README states what goes where, so read it before sending anything embargoed, under double-blind review, or otherwise non-public.
