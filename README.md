...
I use this page as a working notebook for a few **AI-assisted research-auditing** experiments: a small, deliberately versioned family of tools that bring adversarial review to empirical papers, grant proposals, and referee reports. The line runs from a manual, human-in-the-loop **audit protocol** (multi-model: ChatGPT, Gemini, Grok, Claude), to its **automation** for the Claude Code + Codex command line, to a **domain application** for ERC grant drafts — alongside, and feeding back into, the meta-analysis work in the labs below. The tools surface structured criticism for a human to weigh; they are not a substitute for judgment.

The main protocol has been independently endorsed by [Prof. Bob Reed (University of Canterbury / MAER-Net)](https://maer-net.org/post/ai_duel), who plans to use it in his own work.
...
| Curious what my kids built? | [**race**](https://github.com/tjhavranek/race) | A small two-player browser racing game my three kids (ages 8–12) made with Claude Code, set in our town of Litomyšl. Not research — just theirs. |

### Cite the protocol

Iršová & Havránek (2026) — [doi:10.5281/zenodo.19105954](https://doi.org/10.5281/zenodo.19105954). The research repos ship a `CITATION.cff`, so GitHub's "Cite this repository" works too.

### Elsewhere

- Website — [tomashavranek.cz](https://tomashavranek.cz)
- ORCID — [0000-0002-3158-2539](https://orcid.org/0000-0002-3158-2539)
- Labs — [meta-analysis.cz](https://meta-analysis.cz) · [easymeta.org](https://easymeta.org) · [spuriousprecision.com](https://spuriousprecision.com)
